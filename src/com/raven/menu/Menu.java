...
public class Menu extends javax.swing.JPanel {
    ...
    private void initMenu() {
        addMenu("Inicio", "1", 0);
        addMenu("Ver catálogo de cuentas", "2", 1);
        addMenu("Hacer un asiento", "3", 2);
        addMenu("Exportar catálogo", "4", 3);
        addMenu("Balance general", "5", 4);
        addMenu("Estado de resultados", "6", 5);
        addMenu("Configuraciones", "7", 6);
        addMenu("Donaciones", "8", 7);
        addMenu("Equipo", "9", 8);
        addMenu("Salir", "10", 9);
        //  add more menu here
        menu.repaint();
