...
public class TextAreaCellRenderer extends JTextArea implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        //setFont(table.getFont().deriveFont(Font.BOLD));//Fuente del texto
        setFont(table.getFont());//Fuente del texto
        ...
        if (isSelected) {
            ...
            if (row == hoverRow.getIndex()) {
                ...
                setBackground(new Color(82, 82, 82)); //Fondo
            } else {
                /*
                if (row % 2 == 0) {
                    //setBackground(Color.WHITE);
                    setBackground(new Color(82, 82, 82)); //Fila par
                } else {
                    //setBackground(new Color(250, 250, 250));
                    setBackground(new Color(90, 90, 90)); //Fila impar
                }
                */
                setBackground(new Color(61, 61, 61)); //Fila impar
            }
        }
        return this;
    }
