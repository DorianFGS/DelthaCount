...
public class TableCustom {
    ...
    public static void apply(JScrollPane scroll, TableType type) {
        ...
        table.setSelectionBackground(new Color(123, 207, 255)); //Al seleccionar
        //table.setSelectionBackground(new Color(82, 82, 82));
        ...
        //table.setForeground(new Color(250, 250, 250)); //header table
